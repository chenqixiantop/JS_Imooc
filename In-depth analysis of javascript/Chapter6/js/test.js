var items = document.querySelectorAll(".item_"),//获取所有提示文下标
    userAccount = document.querySelector("#userAccount"),//获取用户名
    userPass = document.querySelector("#userPass"),//获取密码
    userPass_ = document.querySelector("#userPass_"),
